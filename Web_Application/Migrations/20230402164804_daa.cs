    ...
    public partial class daa : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Computers", x => x.ComputersId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Visiting_Computers_ComputersId",
                        column: x => x.ComputersId,
                        principalSchema: "Identity",
                        principalTable: "Computers",
                        principalColumn: "ComputersId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Visiting_ComputersId",
                schema: "Identity",
                table: "Visiting",
                column: "ComputersId");

            migrationBuilder.CreateIndex(
                name: "IX_Visiting_HallsCode_ComputersId_DateOfVisit",
                schema: "Identity",
                table: "Visiting",
                columns: new[] { "HallsCode", "ComputersId", "DateOfVisit" },
                unique: true);
